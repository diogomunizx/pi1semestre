    ...
    <main>
        <div class="detalhes-container">
            ...
            <div class="secao">
                ...
                <div class="info-item"><strong>Nome:</strong> <?php echo htmlspecialchars($inscricao['coordenador']); ?></div>
                <div class="info-item"><strong>E-mail:</strong> <?php echo htmlspecialchars($inscricao['email_coordenador']); ?></div>
            </div>
